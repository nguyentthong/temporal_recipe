...
class Blip2VicunaInstruct_MALMM(Blip2Base):
    ...
    def __init__(
        ...
        self.Qformer, self.query_tokens = self.init_Qformer(
            num_query_token, self.visual_encoder.num_features, memory_bank_length=memory_bank_length, num_frames=num_frames, num_experts=num_experts
        )
    ...
    def from_config(cls, cfg):
        ...
        num_experts = cfg.get("num_experts", 2)
