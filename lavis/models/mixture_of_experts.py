...
class MoE(nn.Module):
    ...
    def forward(self, inputs, **kwargs):
        ...
        expert_inputs = torch.einsum('bnd,bnec->ebcd', inputs, dispatch_tensor.to(inputs.dtype))
        ...
        output = torch.einsum('ebcd,bnec->bnd', expert_outputs, combine_tensor.to(expert_outputs.dtype))
