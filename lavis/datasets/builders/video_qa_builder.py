...
from lavis.datasets.datasets.internvid_vqa_datasets import InternVidVQADataset, InternVidVQAEvalDataset
...
@registry.register_builder("internvid_qa")
class InternVidQABuilder(VideoQABuilder):
    train_dataset_cls = InternVidVQADataset
    eval_dataset_cls = InternVidVQAEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/internvid/defaults_qa.yaml",
    }
...
@registry.register_builder("internvid_vidal_qa")
class InternVidVidalQABuilder(VideoQABuilder):
    train_dataset_cls = InternVidVQADataset
    eval_dataset_cls = InternVidVQAEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/internvid_vidal/defaults_qa.yaml",
    }
