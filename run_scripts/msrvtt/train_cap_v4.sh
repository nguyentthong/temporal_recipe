torchrun --nproc_per_node=2 \
    --master_port=14644 \
    train.py \
    --cfg-path lavis/projects/malmm_v4/cap_msrvtt.yaml \
    --options \
    ...
    run.prefix train \
    run.resume_ckpt_path ./output/internvid_vidal_qa/blip2_vicuna_instruct_vicuna7b/train/_freezevit/checkpoint_latest.pth