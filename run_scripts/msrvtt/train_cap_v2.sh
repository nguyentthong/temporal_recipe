torchrun --nproc_per_node=2 \
    --master_port=11000 \
    train.py \
    --cfg-path lavis/projects/malmm_v2/cap_msrvtt.yaml \
    --options \
    ...
    run.prefix train \
    run.resume_ckpt_path ./output/vidal_caption/blip2_vicuna_instruct_vicuna7b/train/_freezevit/checkpoint_latest.pth
