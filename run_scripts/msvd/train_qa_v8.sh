torchrun --nproc_per_node=2 \
    ...
    run.prefix train \
    run.resume_ckpt_path /home/thong/weride_project/weride/megatron_vlm_moe/lavis/output_v8/vidal_caption/blip2_vicuna_instruct_vicuna7b/train/b32_e1_lr1e-05_wd0.05_q32_f32_fb40_freezevit/checkpoint_latest.pth \
