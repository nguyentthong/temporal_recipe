torchrun --nproc_per_node=2 \
    --master_port=16264 \
    train.py \
    --cfg-path lavis/projects/malmm_v4/cap_msvd.yaml \
    --options \
    ...
    run.prefix train \
    run.resume_ckpt_path ./output_v4/msvd_caption/blip2_vicuna_instruct_vicuna7b/train/b32_e5_lr1e-05_wd0.05_q32_f32_fb40_freezevit/checkpoint_latest.pth
